...
import numpy as np
from resistance_vs_temperature import resistance_vs_temperature_reader, linear_plot

from optics.general import curvefit
from optics.resistance_vs_temperature import linear_plot
